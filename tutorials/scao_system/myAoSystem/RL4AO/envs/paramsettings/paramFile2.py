...
def initializeParameterFile():
    ...
    param['fractionnalR0'] = [0.5, 0.3, 0.2]    # 每个湍流层的 Cn² 剖面，表示每个层对总湍流的贡献比例
    param['windSpeed'] = [10, 5, 15]              # 每个湍流层的风速，单位为米/秒
    param['windDirection'] = [0, 60, 180]         # 每个湍流层的风向，单位为度
