...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% INFLUENCE FUNCTIONS COMPUTATION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    #                FWHM of the gaussian depends on the anamorphosis
        ...
        # self.telescope = telescope # 与变形镜关联的望远镜对象
        # self.nSubap = nSubap # 变形镜驱动器网格的子孔径数量（沿望远镜直径）
        # self.mechCoupling = mechCoupling # 驱动器之间的机械耦合系数
        # self.coordinates = coordinates # 用户定义的驱动器坐标
        # self.pitch = pitch # 驱动器间距（单位：米）
        # self.misReg = misReg # 用于应用几何变换的 MisRegistration 对象
        # self.modes = modes # 驱动器影响函数或模态（形状为 [n_pix**2, n_modes]）
        # self.coefs # 变形镜的驱动器系数（单位：米）
        # self.OPD # 光程差，表示变形镜的相位变化
        # self.nValidAct # 有效的驱动器数量
