# 根据matlab Imager代码直接改写，没有用到exposure_time，clock_rate


import numpy as np
from numpy.fft import fft2, fftshift
from tutorials.scao_system.myAoSystem.LensletArray1 import LensletArray
class Imager:
    ...
    def relay(self, source):
        ...
        - source: 光源对象
        """
        self.img_lens.propagate_through(source)  # 传播到透镜阵列
