...
class AOEnv(gym.Env):
    def __init__(self, args):
        ...
        self.observation_space = spaces.Dict({
            "wfs_img": spaces.Box(low=-np.inf, high=np.inf, shape=(self.time_window, 120, 120), dtype=np.float32),
            "far_img": spaces.Box(low=-np.inf, high=np.inf, shape=(self.time_window, 120, 120), dtype=np.float32),
            "slope_vec": spaces.Box(low=-np.inf, high=np.inf, shape=(self.time_window, 664), dtype=np.float32),
            "dm_vec": spaces.Box(low=-np.inf, high=np.inf, shape=(self.time_window, 357), dtype=np.float32)
        })
