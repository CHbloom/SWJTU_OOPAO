...
class AOEnv(gym.Env):
    def __init__(self, args):
        ...
        self.tel = Telescope(resolution=120, diameter=8, samplingTime=1/self.sampling_rate, centralObstruction=0)
        ...
        self.wfs = ShackHartmann(nSubap=20, telescope=self.tel, lightRatio=self.lightRatio, is_geometric=False, threshold_cog=0.01)
