...
class AOEnv(gym.Env):
    def __init__(self, args):
        ...
        # 获取命令行参数
        self.args = args
        self.max_step = args.maxStep
        self.init_gainCL = args.gainCL
        self.gainCL = self.init_gainCL
        self.sampling_rate = args.samplingRate
        self.exposure_time = args.exposureTime
        self.clock_rate = args.clockRate

        self.delay = args.delay # 表示延迟了delay步
        ...
        self.param['lightRatio'] = self.lightRatio
        # self.max_step = 200
        ...
        self.wfs_buffer = deque([np.zeros(self.wfs.nSignal)] * (self.delay+1), maxlen=self.delay+1)
